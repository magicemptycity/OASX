...
/// `multi_account_repeat_new_normal` 协议的动态客户端；复制同 mode 功能时复用该类。
class MultiAccountTaskListFeatureApi {
  MultiAccountTaskListFeatureApi(this.feature, {ApiClient? client})
  ...
  Future<Map<String, dynamic>> getMultiAccountRepeatNewNormalPublicAccounts({
    ...
    final res = await client.request(() => get('/$scriptName/shared-accounts'));
  ...
  Future<bool> addMultiAccountRepeatNewNormalTask({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/tasks',
  ...
  Future<bool> setMultiAccountRepeatNewNormalTaskEnable({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/enable',
  ...
  Future<bool> reorderMultiAccountRepeatNewNormalTasks({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/order',
  ...
  Future<bool> deleteMultiAccountRepeatNewNormalTask({
    ...
    final res = await client.request(
      () =>
          delete('/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName'),
    );
    return res.isSuccess && res.data == true;
  }
  ...
  Future<bool> setMultiAccountRepeatNewNormalTaskStatus({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/status',
  ...
  Future<bool> setMultiAccountRepeatNewNormalTaskProgress({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/task-progress',
        queryParameters: {
  ...
  Future<bool> setMultiAccountRepeatNewNormalLastCompleteTime({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/last-complete-time',
  ...
  Future<bool> rerunMultiAccountRepeatNewNormalAccount({
    ...
    final res = await client.request(
      () => post('/$scriptName/$_base/accounts/$accountIndex/rerun'),
    );
    return res.isSuccess && res.data == true;
  }
  ...
  Future<Map<String, dynamic>> getMultiAccountRepeatNewNormalTaskArgs({
    ...
    final res = await client.request(
      () => get(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/args',
      ),
    );
    return res.isSuccess && res.data is Map
        ? (res.data as Map).cast<String, dynamic>()
  ...
  Future<bool> putMultiAccountRepeatNewNormalTaskArg({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/$groupName/$argumentName/value',
        queryParameters: {'types': type, 'value': value},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> copyMultiAccountRepeatNewNormalTaskPrivateConfig({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/private/copy',
        queryParameters: {
  ...
  Future<bool> resetMultiAccountRepeatNewNormalTaskPrivateConfig({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/private/default',
      ),
    );
    return res.isSuccess && res.data == true;
  }
...
/// `multi_account_repeat_timed` 协议的动态客户端；复制同 mode 功能时复用该类。
class MultiAccountTimedFeatureApi {
  MultiAccountTimedFeatureApi(this.feature, {ApiClient? client})
    : client = client ?? ApiClient();
  final MultiAccountFeatureDescriptor feature;
  final ApiClient client;
  String get _base => feature.apiPrefix;
  ...
  Future<bool> quickScheduleMultiAccountRepeatTimedTask({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/tasks/$taskName/quick-schedule',
...
/// `multi_account_repeat_new_fixed` 协议的动态客户端；复制同 mode 功能时复用该类。
class MultiAccountFixedFeatureApi {
  MultiAccountFixedFeatureApi(this.feature, {ApiClient? client})
    : client = client ?? ApiClient();
  final MultiAccountFeatureDescriptor feature;
  final ApiClient client;
  String get _base => feature.apiPrefix;
  ...
  getMultiAccountRepeatNewFixedFixedTimeTasks({
    ...
    final res = await client.request(
      () => get('/$scriptName/$_base/fixed-time-tasks'),
    );
  ...
  Future<bool> addMultiAccountRepeatNewFixedFixedTimeBatch({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches',
        queryParameters: {
          'name': name,
  ...
  Future<bool> deleteMultiAccountRepeatNewFixedFixedTimeBatch({
    ...
    final res = await client.request(
      () => delete(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId',
      ),
    );
    return res.isSuccess && res.data == true;
  }
  ...
  Future<bool> copyMultiAccountRepeatNewFixedFixedTimeBatch({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/copy',
        queryParameters: {
          'target_account_indexes': targetAccountIndexes.join(','),
        },
      ),
  ...
  Future<bool> setMultiAccountRepeatNewFixedFixedTimeBatchEnable({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/enable',
        queryParameters: {'value': enable},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> setMultiAccountRepeatNewFixedFixedTimeBatchRunTime({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/run-time',
  ...
  Future<bool> setMultiAccountRepeatNewFixedFixedTimeBatchSchedule({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/schedule',
        queryParameters: {
          'run_time': runTime,
  ...
  getMultiAccountRepeatNewFixedFixedTimeBatchSchedulerArgs({
    ...
    final res = await client.request(
      () => get(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/scheduler/args',
      ),
    );
    return res.isSuccess && res.data is Map
        ? (res.data as Map).cast<String, dynamic>()
  ...
  Future<bool> putMultiAccountRepeatNewFixedFixedTimeBatchSchedulerArg({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/scheduler/$argumentName/value',
        queryParameters: {'types': type, 'value': value},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> quickScheduleMultiAccountRepeatNewFixedSpecialTask({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/quick-schedule',
        queryParameters: {'run_now': runNow.toString()},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> rerunMultiAccountRepeatNewFixedSpecialTask({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/rerun',
      ),
    );
    return res.isSuccess && res.data == true;
  }
  ...
  Future<bool> setMultiAccountRepeatNewFixedSpecialTaskLastCompleteTime({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/last-complete-time',
        queryParameters: {'value': value},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> reorderMultiAccountRepeatNewFixedSpecialTaskTasks({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/order',
        queryParameters: {'task_names': taskNames.join('\n')},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> setMultiAccountRepeatNewFixedSpecialTaskTaskStatus({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/$taskName/status',
        queryParameters: {'value': status},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> addMultiAccountRepeatNewFixedFixedTimeBatchTask({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks',
        queryParameters: {'task_name': taskName},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> setMultiAccountRepeatNewFixedFixedTimeBatchTaskEnable({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/$taskName/enable',
        queryParameters: {'value': enable},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  Future<bool> deleteMultiAccountRepeatNewFixedFixedTimeBatchTask({
    ...
    final res = await client.request(
      () => delete(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/$taskName',
      ),
    );
    return res.isSuccess && res.data == true;
  }
  ...
  getMultiAccountRepeatNewFixedFixedTimeBatchTaskArgs({
    ...
    final res = await client.request(
      () => get(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/$taskName/args',
      ),
    );
    return res.isSuccess && res.data is Map
        ? (res.data as Map).cast<String, dynamic>()
  ...
  Future<bool> putMultiAccountRepeatNewFixedFixedTimeBatchTaskArg({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/$taskName/$groupName/$argumentName/value',
        queryParameters: {'types': type, 'value': value},
      ),
    );
    return res.isSuccess && res.data == true;
  ...
  resetMultiAccountRepeatNewFixedFixedTimeBatchTaskPrivateConfigToDefault({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/fixed-time-batches/$batchId/tasks/$taskName/private/default',
      ),
    );
    return res.isSuccess && res.data == true;
  }
...
/// `multi_account_task_orchestration` 协议的动态客户端；复制同 mode 功能时复用该类。
class MultiAccountOrchestrationFeatureApi {
  MultiAccountOrchestrationFeatureApi(this.feature, {ApiClient? client})
    : client = client ?? ApiClient();
  final MultiAccountFeatureDescriptor feature;
  final ApiClient client;
  String get _base => feature.apiPrefix;
  ...
  Future<bool> addMultiAccountTaskOrchestrationSingleTask({
    ...
    final res = await client.request(
      () => post(
        '/$scriptName/$_base/accounts/$accountIndex/single-tasks',
        queryParameters: {'task_name': taskName},
      ),
    );
    return res.isSuccess;
  ...
  Future<bool> quickScheduleMultiAccountTaskOrchestrationSingleTask({
    ...
    final res = await client.request(
      () => put(
        '/$scriptName/$_base/accounts/$accountIndex/single-tasks/$taskName/quick-schedule',
        queryParameters: {'run_now': runNow.toString()},
      ),
    );
    return res.isSuccess && res.data == true;
